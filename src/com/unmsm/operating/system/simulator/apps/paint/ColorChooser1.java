...
public class ColorChooser1 extends JPanel implements ActionListener {
	...
	private final String PRIMARY_COLOR = "Color Primario";
	private final String SECONDARY_COLOR = "Color Secundario";
	...
	private void initializeColorChooser(JToolBar panel) {
		...
		newColor = new JButton("Editar Color");
		...
		panel.add(custom3);
		panel.add(newColor);
		panel.add(new JLabel("Color Principal"));
		panel.add(primaryColor);
                    panel.add(new JLabel("Color Secundario"));
