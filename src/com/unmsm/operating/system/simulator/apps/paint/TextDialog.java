...
public class TextDialog extends JDialog implements ActionListener, ChangeListener {
	...
	TextDialog(Frame owner) {
		...
		example = new JTextField("Ejemplo");
		...
		p0.add(input);
		p0.setBorder(new TitledBorder(new EtchedBorder(), "Texto"));

		JPanel p1 = new JPanel();
		p1.add(fonts);
		p1.setBorder(new TitledBorder(new EtchedBorder(), "Fuente"));

		JPanel p2 = new JPanel(); // use FlowLayout
		p2.add(sizes);
		p2.setBorder(new TitledBorder(new EtchedBorder(), "Tamaño"));
