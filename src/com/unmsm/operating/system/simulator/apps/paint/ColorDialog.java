...
public class ColorDialog extends JDialog implements ActionListener, ChangeListener {
	...
	ColorDialog(Frame owner, Color c) {
		...
		p0.add(red);
		p0.setBorder(new TitledBorder(new EtchedBorder(), "Rojo"));

		JPanel p1 = new JPanel();
		p1.add(green);
		p1.setBorder(new TitledBorder(new EtchedBorder(), "Verde"));

		JPanel p2 = new JPanel(); // use FlowLayout
		p2.add(blue);
		p2.setBorder(new TitledBorder(new EtchedBorder(), "Azul"));
